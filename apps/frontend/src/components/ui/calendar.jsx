...
function Calendar({
  ...
  const cellSize = "var(--cell-size, 2.5rem)";
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative has-[focus]:border-ring border border-input shadow-sm has-[focus]:ring-ring/50 has-[focus]:ring-2 rounded-md",
...
function CalendarDayButton({ className, day, modifiers, children, ...props }) {
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]:bg-primary-500 data-[selected-single=true]:text-primary-foreground",
        "data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground",
        "data-[range-start=true]:bg-primary-500 data-[range-start=true]:text-primary-foreground",
        "data-[range-end=true]:bg-primary-500 data-[range-end=true]:text-primary-foreground",
